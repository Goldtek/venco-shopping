const colors = {
  ...
  comment: '#868686',
  dividerLine: '#dedede',
  dividerBorder: 'rgba(51, 51, 51, 0.1)',
  input: '#f0f5f7',
  textinputborder: '#b4c9d3',
  shadow: '#000000',
  primaryDarkText: 'rgba(0,0,0,0.87)',
  secondaryDarkText: 'rgba(0,0,0,0.54)',
  ...
  minWhite: 'rgba(255, 255, 255, 0.30)',
  activeOutletMarker: '#6476E2',
  inactiveOutletMarker: '#B1B1B1',
  distributorActive: '#F72771',
  distributorInActive: '#F8659A',
  listBorderColor: '#c9c9c9',
  stopComplete: '#53676d',
  tripStartColor: '#13b675',
  tripEndColor: '#ac4ebe',
  tripDisabledColor: '#53676d',
  borderCompleteColor: '#eff3f4',
  borderDefaultColor: '#485a5f',
  whatsapp: '#54C761',
  sms: '#F4E285',
  rIcon: '#e74c3c',
  gIcon: '#1abc9c',
...
export const tabActive = yellow800;
